        ...
        {this.props.renderNope ? (
          ...
          <Animated.View style={[this.props.nopeStyle, animatedNopeStyles]}>
            {this.props.noView ? (
              ...
              <Text style={this.props.nopeTextStyle}>
                {this.props.noText ? this.props.noText : "Nope!"}
              </Text>
            )}
          </Animated.View>
        ) : null}
        ...
        {this.props.renderYup ? (
          ...
          <Animated.View style={[this.props.yupStyle, animatedYupStyles]}>
            {this.props.yupView ? (
              ...
              <Text style={this.props.yupTextStyle}>
                {this.props.yupText ? this.props.yupText : "Like!"}
              </Text>
            )}
          </Animated.View>
        ) : null}
